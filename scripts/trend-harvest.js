...
const MAX_POSTS = Number(process.env.TREND_POST_LIMIT || 8);
const LOOKBACK_DAYS = Number(process.env.TREND_LOOKBACK_DAYS || 1);

const FALLBACK_QUERIES = [
  "whole home water filtration system dallas fort worth",
  "pfas water filter texas families",
  "best water softener installation dfw",
  "chloramine removal whole home filter north texas",
  "reverse osmosis drinking water system plano frisco",
  "lead copper water filter dallas mckinney",
  "water purification system for family dfw",
  "emergency water filter boil notice fort worth"
];
    ...
    <header class="site-header nav-ready">
      <div class="container header-inner">
        <a class="brand" href="index.html" aria-label="Mission Pure home">
          <img class="brand-logo" src="assets/logo.webp?v=202605310925" alt="Mission Pure" />
